...
const Navbar = () => {
  return (
    <div className='max-w-screen-xl py-6 flex items-center mx-auto justify-between border-b-[1px] border-zinc-700'>
            ...
            <div className='font-regular links flex gap-14 ml-20'>
                {["Home" , "Work" , "Culture" , "" , "News"].map((elem , index) => ( 
                    elem.length === 0 ? <span key = {index} className='w-[2px] h-7 bg-zinc-700'></span> : (
                        <button className='text-sm flex items-center gap-1' href='#'>
